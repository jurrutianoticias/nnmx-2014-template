...
<?php //if(!empty($content['blog']['#items'][0]['value'])): ?>
<h3><?php print render($content['links']['blog']['#links']['blog_usernames_blog']['title']); ?></h3>
<?php //endif; ?>
<?php //fecha de publicacion ?>
<time><?php print $date; ?></time>
<?php //slideshow de fotos ?>
<?php if(!empty($content['field_blog_foto']['#items'])): ?>
<div class="galeria">
  <?php print render($content['field_blog_foto']); ?>
</div>
<?php endif; ?>
